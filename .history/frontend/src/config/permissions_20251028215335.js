...
export const PERMISSIONS = {
  administrador: [
    ...
    'modificar_boleta',
    'ver_boletas',
    'ver_mis_visitas'  // ✅ Admin puede ver visitas
  ],
  ...
  vendedor: [
    ...
    'registrar_boleta',
    // 'registrar_visita',  // ❌ REMOVIDO - Vendedor NO puede registrar visitas
    'ver_mis_visitas',      // ✅ Vendedor solo puede VER sus visitas
    'buscar_pedido',
    'registrar_pedido',
    'buscar_producto',
    'buscar_cliente',
...
export const MENU_ITEMS = [
  ...
  },
  {
    title: 'Visitas',
    icon: '📅',
    permission: 'ver_mis_visitas',  // ✅ Permiso que tienen ambos (admin y vendedor)
    subItems: [
      {
      ...
      },
      {
        ...
        permission: 'ver_mis_visitas'  // ✅ Admin y vendedor
      }
    ]
  },
  {

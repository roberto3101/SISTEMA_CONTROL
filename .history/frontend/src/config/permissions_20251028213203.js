...
export const PERMISSIONS = {
  ...
  vendedor: [
    ...
    'registrar_boleta',
    // 'registrar_visita',  // ❌ REMOVIDO - Ya NO puede registrar visitas
    'ver_mis_visitas',      // ✅ NUEVO - Solo puede ver sus visitas
    'buscar_pedido',
    'registrar_pedido',
    'buscar_producto',
    'buscar_cliente',
...
export const MENU_ITEMS = [
  ...
  },
  {
    title: 'Visitas',
    icon: '📅',
    permission: 'ver_mis_visitas',  // ✅ CAMBIADO - Ahora usa un permiso que tanto admin como vendedor tienen
    subItems: [
      {
        title: 'Registrar Visita',
        path: '/visitas/registrar',
        permission: 'registrar_visita'  // ✅ Solo admin tiene este permiso
      },
      {
        title: 'Mis Visitas',
        path: '/visitas/mis-visitas',
        permission: 'ver_mis_visitas'  // ✅ Admin y vendedor tienen este permiso
      }
    ]
  },
  {
